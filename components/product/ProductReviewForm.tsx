...
export default function ProductReviewForm({ productId }: ProductReviewFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingId) {
      await updateFeedback(productId, editingId, { rating, comment });
      ...
      const newFeedback: Feedback = {
        ...
        rating,
        comment,
        date: '' // Will be replaced by backend
      };
      await addFeedback(productId, newFeedback);
              ...
              <div className="flex items-center gap-4">
                ...
                {user && user.name === f.userName && (
                  <div className="flex gap-2 shrink-0">
                    ...
                    <button onClick={async () => await removeFeedback(productId, f.id)} className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all" title="Delete Review">

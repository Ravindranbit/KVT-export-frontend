    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4">
        <div className="relative">
          ...
          <input type="text" placeholder="Search by order ID or customer..." value={search} onChange={(e) => setSearch(e.target.value)} className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500" />
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-3 justify-center max-w-[200px] mx-auto">
                    ...
                    {o.items.length > 0 && (
                      <div className="min-w-0 flex-1">
                        ...
                        {o.items.length > 1 && (
                          <p className="text-[10px] text-red-600 font-black tracking-tight mt-0.5 uppercase">
